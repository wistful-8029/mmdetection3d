...
load_lift_from = '/media/data/lkq/my_pth/bevfusion/cam_pp.pth'     #####load cam stream
load_from = '/media/data/lkq/my_pth/bevfusion/hv_pointpillars_secfpn_sbn-all_4x8_2x_nus-3d_e24.pth'  #####load lidar stream
